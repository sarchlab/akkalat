...
exps = [
    ...
    # ("64CUPerGPU_withCache", "fastwalshtransform", [" -num-memory-banks=16 -bandwidth=96"]),
    # ("32CUPerGPU_withCache", "im2col", [" -num-memory-banks=16 -bandwidth=96"]),
    # ("32CUPerGPU_withCache", "matrixtranspose", [" -num-memory-banks=16 -bandwidth=96"]),
    # ("32CUPerGPU_withCache", "pagerank", [" -num-memory-banks=16 -bandwidth=96"]),
    # ("32CUPerGPU_withCache", "fir", [" -num-memory-banks=16 -bandwidth=96"]),
    # ("32CUPerGPU_withCache", "relu", [" -num-memory-banks=16 -bandwidth=96"]), 
    # ("32CUPerGPU_withCache", "spmv", [" -num-memory-banks=16 -bandwidth=96"]), 
    # ("32CUPerGPU_withCache", "spmv", [" -num-memory-banks=16 -bandwidth=96"]), 
    ...
    # ("32CUPerGPU_withGMMU", "relu", []),
    # ("32CUPerGPU_withGMMU", "bicg", []),
    # ("32CUPerGPU_withGMMU", "bitonicsort", []),
    # ("32CUPerGPU_withGMMU", "fastwalshtransform", []),
    # ("32CUPerGPU_withGMMU", "fir", []),
    # ("32CUPerGPU_withGMMU", "fft", []),
    # ("32CUPerGPU_withGMMU", "im2col", []),
    # ("32CUPerGPU_withCacheVirtualCache", "kmeans", [" -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withCacheVirtualCache", "matrixmultiplication", [" -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withGMMU", "matrixtranspose", []),
    # ("32CUPerGPU_withCacheVirtualCache", "nbody", [" -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withCacheVirtualCache", "nw", [" -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withGMMU", "pagerank", []),
    # ("32CUPerGPU_withCache", "fir", ["-benchmark-size=4194304 -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withCache", "fir", ["-benchmark-size=8388608 -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withCache", "fir", ["-benchmark-size=16777216 -num-memory-banks=16 -bandwidth=96 "]),
    # ("32CUPerGPU_withCacheVirtualCache", "spmv", [" -num-memory-banks=16 -bandwidth=96 "]),

    ("32CUPerGPU_withGMMUBestPerformance", "bitonicsort", []),
    ("32CUPerGPU_withGMMUBestPerformance", "conv2d", []),
    ("32CUPerGPU_withGMMUBestPerformance", "fastwalshtransform", []),
    ("32CUPerGPU_withGMMUBestPerformance", "fir", []),
    ("32CUPerGPU_withGMMUBestPerformance", "fft", []),
    ("32CUPerGPU_withGMMUBestPerformance", "floydwarshall", []),
    ("32CUPerGPU_withGMMUBestPerformance", "im2col", []),
    ("32CUPerGPU_withGMMUBestPerformance", "kmeans", []),
    ("32CUPerGPU_withGMMUBestPerformance", "matrixmultiplication", []),
    ("32CUPerGPU_withGMMUBestPerformance", "matrixtranspose", []),
    ("32CUPerGPU_withGMMUBestPerformance", "pagerank", []),
    ("32CUPerGPU_withGMMUBestPerformance", "simpleconvolution", []),
    ("32CUPerGPU_withGMMUBestPerformance", "spmv", []),
    ("32CUPerGPU_withGMMUBestPerformance", "stencil2d", []),
    # ("32CUPerGPU_withGMMU", "lenet", []),
    # ("32CUPerGPU_withGMMU", "minerva", []),
    # ("32CUPerGPU_withGMMU", "vgg16", []),
]
...
def run_exp(exp):
    try:
        ...
        cmd = f"{cwd}/{exp[0]}/{exp[0]} -benchmark={exp[1]} -timing " + \
            f" -num-memory-banks=16 -bandwidth=96 " + \
...
def create_output_dir():
    global output_dir
    output_dir = f'results/{datetime.now().strftime("%Y-%m-%d-%H-%M-%S-7x732GMMU")}'
